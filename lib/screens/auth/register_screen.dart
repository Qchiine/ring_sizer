...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  UserRole _selectedRole = UserRole.buyer; // Rôle par défaut
  ...
  Future<void> _submit() async {
    ...
    final success = await authProvider.register(
      ...
      _selectedRole.name, // Envoyer le nom du rôle ('buyer' ou 'seller')
    );
    ...
    // La redirection est gérée par AuthWrapper, donc pas besoin de naviguer ici.
  }
